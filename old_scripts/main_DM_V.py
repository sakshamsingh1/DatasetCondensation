...
from additional_utils.train_utils_DM import create_net,  eval_synthetic, realBatchPT
...
def main(args):
    ...
    real_images = realBatchPT(args.list_train, args)
    ...
    for it in range(args.Iteration+1):
        ...
        for c in range(num_classes):
            ...
            output_real = net_frame(img_real).detach()
            output_syn = net_frame(img_syn)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='AVE_image_64', help='dataset')
    ...
    result_path = os.path.join(args.save_path, 'res_%s_%s_%dipc.pt'%(args.method, args.dataset, args.ipc))
